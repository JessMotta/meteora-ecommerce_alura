...
export default function DialogMessage({isOpen, onClose}: DialogMessageInterface) {
    ...
    return (
        <div className="fixed inset-0 flex justify-center items-center z-50">
            ...
            <div className="relative bg-white shadow-[0_4px_15px_0_rgba(44, 63, 88, 0.35)]">
                <div className="bg-black z-100 text-white flex justify-between w-[700px] items-center px-4 py-5">
