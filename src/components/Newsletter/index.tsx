...
export function Newsletter() {
    return (
        <div className="w-full my-[60px]">
            <div className="border-2 border-black max-w-[730px] px-4 py-10 text-center mx-auto">
                ...
                <Form action="/">
                    ...
                    className="border-1 border-black lg:w-[456px] md:w-[350px] sm:w-[200px] placeholder:text-(--color-gray) py-2 px-4"
                    />
